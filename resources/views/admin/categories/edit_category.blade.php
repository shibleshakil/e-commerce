...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Categoris</a> <a href="#" class="current">Edit Category</a> </div>
    <h1>Categories</h1>
  </div>
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{url('/admin/edit-category/'.$categoryDetails->id) }}" name="edit_category" id="edit_category" novalidate="novalidate">@csrf
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea name="discription" id="discription">{{$categoryDetails->discription}} </textarea>
                </div>
              </div>
              <div class="control-group">
